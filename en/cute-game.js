(() => {
  ...
  const LEVELS = [
    {
      ...
      pre: [
        { speaker: "NEUROMIRON", text: "A heart isn’t an argument. You’re changing the subject.", left: 'dora-idle', right: 'miron-defiant' },
        { speaker: "NEURODORA", text: "And yet you’re already arguing.", left: 'dora-wink', right: 'miron-defiant' },
        { speaker: "NEUROMIRON", text: "I’m clarifying the wording.", left: 'dora-blink', right: 'miron-angry' },
        { speaker: "NEURODORA", text: "Then come a little closer.", left: 'dora-ready', right: 'miron-angry' }
      ],
      post: [
        { speaker: "NEUROMIRON", text: "The collar really was crooked.", left: 'dora-wink', right: 'miron-flustered' },
        { speaker: "NEURODORA", text: "I told you so.", left: 'dora-idle', right: 'miron-soft' },
        { speaker: "NEUROMIRON", text: "You didn’t say anything.", left: 'dora-blink', right: 'miron-kind' },
        { speaker: "NEURODORA", text: "But I fixed it.", left: 'dora-wink', right: 'miron-farewell' },
        { speaker: "NEUROMIRON", text: "Convincing.", left: 'dora-wink', right: 'miron-farewell' }
      ]
    },
    {
      name: "NEUROSLAVA",
      ...
      pre: [
        { speaker: "NEUROSLAVA", text: "I already don’t like this.", left: 'dora-idle', right: 'slava-defiant' },
        { speaker: "NEURODORA", text: "I haven’t done anything yet.", left: 'dora-blink', right: 'slava-angry' },
        { speaker: "NEUROSLAVA", text: "Exactly. And it’s making me nervous.", left: 'dora-wink', right: 'slava-defiant' },
        { speaker: "NEURODORA", text: "I could start.", left: 'dora-idle', right: 'slava-defiant' },
        { speaker: "NEUROSLAVA", text: "Now it’s even worse.", left: 'dora-ready', right: 'slava-angry' },
        { speaker: "NEUROSLAVA", text: "Fine. If I like it, it’s post-irony.", left: 'dora-ready', right: 'slava-defiant' }
      ],
      post: [
        { speaker: "NEUROSLAVA", text: "That fist bump was an accident.", left: 'dora-idle', right: 'slava-flustered' },
        { speaker: "NEURODORA", text: "Of course.", left: 'dora-wink', right: 'slava-soft' },
        { speaker: "NEUROSLAVA", text: "So was the smile.", left: 'dora-idle', right: 'slava-defiant' },
        { speaker: "NEURODORA", text: "I didn’t see that.", left: 'dora-blink', right: 'slava-soft' },
        { speaker: "NEUROSLAVA", text: "Then it’s settled.", left: 'dora-victory', right: 'slava-kind' }
      ]
    },
    {
      name: "NEUROMAYBE",
      ...
      interactionScale: 1.06,
      pre: [
        { speaker: "NEUROMAYBE", text: "Welcome to Maybeland. Don’t get comfortable.", left: 'dora-idle', right: 'maybe-defiant' },
        { speaker: "NEURODORA", text: "I’ll just fix your bow.", left: 'dora-wink', right: 'maybe-angry' },
        { speaker: "NEUROMAYBE", text: "Don’t touch the bow.", left: 'dora-blink', right: 'maybe-defiant' },
        { speaker: "NEURODORA", text: "It’s crooked.", left: 'dora-ready', right: 'maybe-angry' },
        { speaker: "NEUROMAYBE", text: "Come closer and you’ll regret it.", left: 'dora-ready', right: 'maybe-defiant' }
      ],
      post: [
        { speaker: "NEUROMAYBE", text: "Hands off. I’m not a little kid.", left: 'dora-idle', right: 'maybe-flustered' },
        { speaker: "NEURODORA", text: "Done.", left: 'dora-blink', right: 'maybe-kind' },
        { speaker: "NEUROMAYBE", text: "…Not so fast.", left: 'dora-wink', right: 'maybe-flustered' },
        { speaker: "NEURODORA", text: "One more time?", left: 'dora-idle', right: 'maybe-kind' },
        { speaker: "NEUROMAYBE", text: "Just once. And don’t tell anyone.", left: 'dora-victory', right: 'maybe-victory' },
        { speaker: "NEURODORA", text: "Deal.", left: 'dora-wink', right: 'maybe-kind' },
        { speaker: "NEUROMAYBE", text: "And I’m sticking with you.", left: 'dora-idle', right: 'maybe-kind' },
        { speaker: "NEURODORA", text: "Is that a secret too?", left: 'dora-wink', right: 'maybe-flustered' },
        { speaker: "NEUROMAYBE", text: "For now.", left: 'dora-victory', right: 'maybe-victory' }
      ]
    },
    {
      name: "NEUROMORGEN",
      ...
      pre: [
        { speaker: "NEUROMORGEN", text: "Both of you? That’s an expensive lineup.", left: 'dora-idle', right: 'morgen-defiant' },
        { speaker: "NEUROMAYBE", text: "Nobody asked you.", left: 'maybe-defiant', right: 'morgen-angry' },
        { speaker: "NEUROMORGEN", text: "That wasn’t the deal. One at a time.", left: 'maybe-angry', right: 'morgen-defiant' },
        { speaker: "NEURODORA", text: "Not happening.", left: 'dora-blink', right: 'morgen-angry' },
        { speaker: "NEUROMORGEN", text: "Got it. This’ll be loud.", left: 'dora-ready', right: 'morgen-defiant' }
      ],
      post: [
        { speaker: "NEUROMORGEN", text: "Don’t post the photo.", left: 'maybe-kind', right: 'morgen-flustered' },
        { speaker: "NEUROMAYBE", text: "Too late.", left: 'maybe-victory', right: 'morgen-soft' },
        { speaker: "NEUROMORGEN", text: "Is it at least a good one?", left: 'maybe-kind', right: 'morgen-kind' },
        { speaker: "NEURODORA", text: "You’re smiling in it.", left: 'dora-wink', right: 'morgen-flustered' },
        { speaker: "NEUROMORGEN", text: "Then post it.", left: 'dora-idle', right: 'morgen-soft' },
        { speaker: "NEUROMAYBE", text: "Then it’s settled.", left: 'maybe-victory', right: 'morgen-kind' }
      ]
    }
  ];
  ...
  const PROLOGUE = [
    {
      speaker: "NEURODORA",
      text: "They say I’m too cute for a fight.",
      left: null,
      right: 'dora-idle'
    },
    {
      speaker: "NEURODORA",
      text: "I wasn’t planning to fight anyway.",
      left: null,
      right: 'dora-wink'
    },
    {
  ...
  const EPILOGUE = [
    {
      speaker: "NEURODORA",
      text: "Well? Anyone else against cute rock?",
      left: 'dora-victory',
      right: 'maybe-kind'
    },
    {
      speaker: "NEUROSLAVA",
      text: "I’ll abstain for now.",
      left: 'dora-victory',
      right: 'slava-kind'
    },
    {
      speaker: "NEUROMIRON",
      text: "That’s called “changing your mind”.",
      left: 'miron-kind',
      right: 'slava-flustered'
    },
    {
      speaker: "NEUROSLAVA",
      text: "Don’t ruin the moment.",
      left: 'miron-kind',
      right: 'slava-flustered'
    },
    {
      speaker: "NEUROMORGEN",
      text: "Move closer. Let’s take a photo.",
      left: 'maybe-kind',
      right: 'morgen-kind'
    },
    {
      speaker: "NEUROMAYBE",
      text: "Dora, you’re with me.",
      left: 'dora-victory',
      right: 'maybe-victory'
    },
    {
  ...
  function showResult(won) {
    ...
    if (won) {
      ui.resultKicker.textContent = "CUTE ROCK VS. EVERYONE";
      ui.resultTitle.textContent = "VICTORY";
      ui.resultText.textContent = "GAME COMPLETE.";
      show(ui.telegram);
      ...
      ui.resultText.textContent = "TRY AGAIN.";
      hide(ui.telegram);
    }
  ...
  ui.start.innerHTML = "<span>LOADING</span><b>♥</b>";
  Promise.all([spritesReady, preloadPortraits(PROLOGUE)]).then(() => {
    ready = true;
    ui.start.disabled = false;
    ui.start.innerHTML = "<span>PLAY</span><b>♥</b>";
  });
  ...
  ui.sound.addEventListener('click', () => {
    ...
    ui.sound.setAttribute('aria-label', game.muted ? "Unmute sound" : "Mute sound");
    syncBackgroundMusic();
    if (!game.muted) {
      preloadSoundEffects();
